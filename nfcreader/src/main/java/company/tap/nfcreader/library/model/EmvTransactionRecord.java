 ...
 */
package company.tap.nfcreader.library.model;

import java.io.Serializable;
import java.util.Date;

import company.tap.nfcreader.library.model.enums.CountryCodeEnum;
import company.tap.nfcreader.library.model.enums.CurrencyEnum;
import company.tap.nfcreader.library.model.enums.TransactionTypeEnum;
import company.tap.nfcreader.library.parser.apdu.annotation.Data;
import company.tap.nfcreader.library.parser.apdu.impl.AbstractByteBean;
import company.tap.nfcreader.library.parser.apdu.impl.DataFactory;

...
import company.tap.nfcreader.library.enums.CommandEnum;
import company.tap.nfcreader.library.enums.EmvCardScheme;
import company.tap.nfcreader.library.enums.SwEnum;
import company.tap.nfcreader.library.exception.CommunicationException;
import company.tap.nfcreader.library.iso7816emv.EmvTags;
import company.tap.nfcreader.library.iso7816emv.EmvTerminal;
import company.tap.nfcreader.library.iso7816emv.TLV;
import company.tap.nfcreader.library.iso7816emv.TagAndLength;
import company.tap.nfcreader.library.log.Logger;
import company.tap.nfcreader.library.log.LoggerFactory;
import company.tap.nfcreader.library.model.Afl;
import company.tap.nfcreader.library.model.EmvCard;
import company.tap.nfcreader.library.model.EmvTransactionRecord;
import company.tap.nfcreader.library.model.enums.CurrencyEnum;
import company.tap.nfcreader.library.utils.BytesUtils;
import company.tap.nfcreader.library.utils.CommandApdu;
import company.tap.nfcreader.library.utils.ResponseUtils;
import company.tap.nfcreader.library.utils.TlvUtil;
import company.tap.nfcreader.library.utils.TrackUtils;
